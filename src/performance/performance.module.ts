...
export const PROVIDED_PERFORMANCE_INSTANCES = new InjectionToken<Performance[]>(
  'angularfire2.performance-instances'
);
...
export function defaultPerformanceInstanceFactory(
  ...
  const defaultPerformance = ɵgetDefaultInstanceOf<FirebasePerformance>(
    PERFORMANCE_PROVIDER_NAME,
    provided,
    defaultApp
  );
...
export function performanceInstanceFactory(
