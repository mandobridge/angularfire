...
export const PROVIDED_STORAGE_INSTANCES = new InjectionToken<Storage[]>(
  'angularfire2.storage-instances'
);

export function defaultStorageInstanceFactory(
  provided: FirebaseStorage[] | undefined,
  defaultApp: FirebaseApp
) {
  const defaultStorage = ɵgetDefaultInstanceOf<FirebaseStorage>(
...
export function storageInstanceFactory(
